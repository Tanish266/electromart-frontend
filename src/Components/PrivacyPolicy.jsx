    ...
    <>
      <div className="Privacy_Policy">
        ...
        <p>
          ...
          describes how electromart Internet Private Limited and its affiliates
          (collectively “electromart, we, our, us”) collect, use, share or
          otherwise process your personal data through electromart website
        ...
        <p>
          ...
          VIP or similar programs offered by electromart, we will collect and
          store your personal data such as name, contact number, email address,
          ...
          electromart or a third-party business partner that operates
          ...
          electromart platform and such third-party business partner platforms.
          ...
          electromart UPI platform. electromart shall not be responsible for the
        ...
        <p>
          electromart has onboarded certain third-party business partners on the
          ...
          electromart login credentials after seeking your permissions to share
          the data further. electromart shall not be responsible for the
        ...
        <p>
          ...
          products and services, and promotional offers. To the extent we use
          your personal data to market to you, we will provide you the ability
          to opt-out of such uses. We use your personal data to assist sellers
          and business partners in handling and fulfilling orders; enhancing
          ...
          experience; report to regulatory authorities wherever required, detect
          and protect us against error, fraud and other criminal activity;
          enforce our terms and conditions; and as otherwise described to you at
        ...
        <p>
          ...
          information report (from credit agencies), GST Number, Government
          issued ID cards/number and Know-Your-Customer (KYC) details to: (i)
          check your eligibility for certain products and services like
          insurance, credit and payment products; (ii) issue GST invoice for the
          products and services purchased for your business requirements; (iii)
          enhance your experience on the Platform and provide you access to the
          products and services being offered by us, sellers, affiliates or
        ...
        <p>
          ...
          meaning that they are automatically deleted from your hard drive at
          the end of a session. You are always free to decline/delete our
          cookies if your browser permits, although in that case you may not be
          able to use certain features on the Platform and you may be required
          ...
          not control the use of cookies by third parties. We use cookies from
          ...
          personal data here: https://www.google.com/intl/en/policies/privacy/.
          You can opt-out of Google Analytics here:
          https://tools.google.com/dlpage/gaoptout. You can also control the use
        ...
        <p>
          ...
          Innovations Private Limited, and other electromart affiliates, related
          companies and third parties, including Credit Bureaus and business
          partners (such as UPI platform), for purposes of providing products
          and services offered by them, such as, personal loans offered by
          Scapic Innovations Private Limited through its lending partners,
          insurance, the deferred payment options, electromart PayLater offered
          by electromart Advanz Private Limited through its lending partners.
          These entities and affiliates may share such information with their
          affiliates, business partners and other third parties for the purpose
          of conducting the required checks, namely for the purpose of credit
          underwriting, providing you their products and services and may market
        ...
        <p>
          ...
          business partners. This disclosure may be required for us to provide
          you access to our products and services; for fulfillment of your
          orders; for enhancing your experience; for providing feedback on
          ...
          to analyze data; for customer service assistance; to prevent, detect,
          mitigate, and investigate fraudulent or illegal activities related to
          our product and services. We may disclose personal data if required to
        ...
        <p>
          ...
          privacy policies. electromart shall not be responsible for the privacy
        ...
        <p>
          ...
          to this and other websites in order to provide personalized
          advertisements about goods and services of interest to you. You have
          an option to opt out from tracking of personalized advertising using
          the “Opt out of Ads Personalization” settings using your device's
          settings application. electromart will have no access to your GAID
          once you select this feature.
        </p>
        ...
        <p>
          ...
          age of 18 years. If you have shared any personal data of children
          under the age of 18 years, you represent that you have the authority
          to do so and permit us to use the information in accordance with this
          Privacy Policy.
        </p>
        ...
        <p>
          ...
          prevent fraud or future abuse, to enable electromart to exercise its
          legal rights and/or defend against legal claims or if required by law
          or We may continue to retain your data in anonymised form for
        ...
        <p>
          ...
          withdraw consent given to us under this Privacy Policy, such
        ...
        <p>
          ...
          processing of your personal data on the Platform in accordance with
          this Privacy Policy. If you disclose to us any personal data relating
          to other people, you represent that you have the authority to do so
          and to permit us to use the data in accordance with this Privacy
          Policy.
        </p>
        <p>
          ...
          messaging apps, call and/or e-mail for the purposes specified in this
          Privacy Policy.
        </p>
        ...
        <p>
          ...
          or usage of your personal data under this Privacy Policy, please
          contact us at privacy.grievance@electromart.com
        </p>
        <p>
